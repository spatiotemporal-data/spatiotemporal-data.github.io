...
# Analyzing Million of Taxi Trips in the City of Chicago
...
Figure 2 shows both pickup and dropoff trips of taxi on 77 community areas in Chicago. Note that the average trip duration is **1207.75 seconds** and the average trip distance is **6.16 miles**.
...
Figure 3 shows both pickup and dropoff trips of E-scooter on 77 community areas in Chicago, see [how to process and visualize E-scooter trips](https://spatiotemporal-data.github.io/Chicago-mobility/e-scooter/). Note that the average trip duration is **913.18 seconds** and the average trip distance is **2448.60 meters**.
