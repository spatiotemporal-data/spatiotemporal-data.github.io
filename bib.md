...
=======
- A. Sandryhaila, J.M.F. Moura (2013). [Discrete signal processing on graphs: graph filters](https://users.ece.cmu.edu/~asandryh/papers/icassp13.pdf). Section 3: Graph Filters.
>>>>>>> Stashed changes
