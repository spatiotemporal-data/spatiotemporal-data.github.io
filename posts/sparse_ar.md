...
<div class="container">
    ...
    <div class="toc-sidebar">
        ...
        <div class="toc-section">
            <div class="toc-section-main" onclick="scrollToSection('part-i')">Part I: Univariate Autoregression</div>
            <div class="toc-subsection" onclick="scrollToSection('i-a')">I-A. Definition of Autoregression</div>
            <div class="toc-subsection" onclick="scrollToSection('i-b')">I-B. Motivation of Sparse Autoregression</div>
        </div>
        
        <div class="toc-section">
            <div class="toc-section-main" onclick="scrollToSection('part-ii')">Part II: Sparse Autoregression</div>
            <div class="toc-subsection" onclick="scrollToSection('ii-a')">II-A. Mixed-Integer Programming</div>
            <div class="toc-subsection" onclick="scrollToSection('ii-b')">II-B. Semidefinite Programming</div>
        </div>
        
        <div class="toc-section">
            <div class="toc-section-main" onclick="scrollToSection('part-iii')">Part III: Time-Varying Sparse Autoregression</div>
            <div class="toc-subsection" onclick="scrollToSection('iii-a')">III-A. Ridesharing Data</div>
            <div class="toc-subsection" onclick="scrollToSection('iii-b')">III-B. Formulating Time-Varying Systems</div>
            <div class="toc-subsection" onclick="scrollToSection('iii-c')">III-C. Solving the Optimization Problem</div>
        </div>
        
        <div class="toc-section">
            <div class="toc-section-main" onclick="scrollToSection('part-iv')">Part IV: Periodicity of Hangzhou Metro</div>
            <div class="toc-subsection" onclick="scrollToSection('iv-a')">IV-A. Data Description</div>
            <div class="toc-subsection" onclick="scrollToSection('iv-b')">IV-B. Periodicity Analysis</div>
            <div class="toc-subsection" onclick="scrollToSection('iv-c')">IV-C. Spatially-Varying Systems</div>
        </div>
        
        <div class="toc-section">
            <div class="toc-section-main" onclick="scrollToSection('part-v')">Part V: Wikipedia Traffic Time Series</div>
            <div class="toc-subsection" onclick="scrollToSection('v-dataset')">Dataset</div>
        </div>
