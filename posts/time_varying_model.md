...
<p align = "center"><img align="middle" src="https://latex.codecogs.com/svg.latex?\normalsize&space;\begin{cases} \boldsymbol{W}:=\{\boldsymbol{W}\mid\frac{\partial f}{\partial\boldsymbol{W}}=\boldsymbol{0}\}\quad\text{\color{gray}(least squares)} \\ \boldsymbol{G}:=\{\boldsymbol{G}\mid\frac{\partial f}{\partial\boldsymbol{G}}=\boldsymbol{0}\}\quad\text{\color{gray}(least squares)} \\ \end{cases}"/></p>
