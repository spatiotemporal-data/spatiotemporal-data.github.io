...
<p align="center">
<img align="middle" src="https://spatiotemporal-data.github.io/images/sin_cos_functions.png" width="500" />
</p>

<p style="font-size: 14px; color: gray" align = "center">
<b>Figure 3.</b> Illustration of Manhattan distance from the point <img style="display: inline;" src="https://latex.codecogs.com/svg.latex?&space;A"/> to <img style="display: inline;" src="https://latex.codecogs.com/svg.latex?&space;B"/> with the distance vector <img style="display: inline;" src="https://latex.codecogs.com/svg.latex?&space;(x_1,x_2,\cdots,x_7)^\top"/>. Please see <a href="https://github.com/xinychen/awesome-latex-drawing/blob/master/norms/manhattan_distance.tex">LaTeX code</a> on GitHub.
</p>
